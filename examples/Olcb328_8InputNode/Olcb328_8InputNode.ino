...
#define NEW_NODEID 2,1,13,0,0,0x0B   // DIY range example, not for global use.

// Uncomment to Force Reset to Factory Defaults -- must do this at least once
#define RESET_TO_FACTORY_DEFAULTS 1

// Board definitions
#define MANU "OpenLCB"           // The manufacturer of node
#define MODEL "8ProducerNode"    // The model of the board
...
int pins[] = { 4,5,14,15,16,17,18,19 };  // 8 inputs
