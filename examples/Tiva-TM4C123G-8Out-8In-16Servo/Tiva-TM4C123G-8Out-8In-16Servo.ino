//==============================================================
// TI Tiva TM4C123G LaunchPad 8-Outputs 8-Inputs 16-Servos 
// 
// Copyright 2019 Alex Shepherd and David Harris
//==============================================================

// Board definitions
#define MANU "TI"  // The manufacturer of node
#define MODEL "Tiva TM4C123G"        // The model of the board
#define HWVERSION "1.0"   // Hardware version
#define SWVERSION "1.0"   // Software version
...
#define FIRST_SERVO_EVENT_INDEX  (FIRST_INPUT_EVENT_INDEX + NUM_INPUTS*2)

#define NUM_EVENT  ((NUM_OUTPUTS*2) + (NUM_INPUTS * 2) + (NUM_SERVOS * 2))
...
// ===== Process Consumer-eventIDs =====
   void pceCallback(unsigned int index) {
      ...
      else if ( (index >= FIRST_SERVO_EVENT_INDEX) && (index < (FIRST_SERVO_EVENT_INDEX + (NUM_SERVOS * 2) ) ) )
      {
        ...
        DEBUG(F("Write Servo: ")); DEBUG(outputIndex); DEBUG(F(" State: ")); DEBUGL(outputState);
