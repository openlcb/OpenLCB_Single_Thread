...
// -------------------------------------------------------------
FlexCANv1::FlexCANv1(uint32_t baud)
{
                //Serial.print("\nIn FlexCANv1::create()");
...
// -------------------------------------------------------------
void FlexCANv1::begin(const CAN_filter_t &mask)
{
                //Serial.print("\nIn FlexCANv1::begin()");
  FLEXCAN0_RXMGMASK = 0;
...
// -------------------------------------------------------------
void FlexCANv1::setFilter(const CAN_filter_t &filter, uint8_t n)
{
  if ( 8 > n ) {
    if (filter.ext) {
...
// -------------------------------------------------------------
int FlexCANv1::read(CAN_message_t &msg)
{
                    //Serial.print("\nIn FlexCANv1::read()");
...
// -------------------------------------------------------------
int FlexCANv1::write(const CAN_message_t &msg)
{
  unsigned long int startMillis;
